...
function image() {
    ...
    img1.innerHTML = "&lt;img src='lego.png'&gt;<br>";
    document.getElementById('editor').appendChild(img1);
    var img2 = document.createElement("div");
    img2.innerHTML = "<img src='res/lego.png'>";
...
function audio(){
    ...
    audio2.innerHTML = "<audio controls><source src='res/SampleAudio.mp3'></source></audio><br>";
